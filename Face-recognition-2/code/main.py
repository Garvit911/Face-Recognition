...
while True:
   ...
   print("Looping")
   imgS = cv2.resize(img, (0, 0), None, 0.25, 0.25)  # choti kardi
   ...
   if len(FaceCurFrame) > 0:
    ...
    for encoFace, faceLoc in zip(encodeCurFrame, FaceCurFrame):
        ...
        if matches[matchIndex]:
            ...
            if counter == 0:
                counter = 1
                modeType = 1   # chnage mode to show the details of the student
            ...
            if counter != 0:
                if counter == 1:
                    ...
                    if imgStudent is not None:
                        ...
                        print(f"Warning: Could not find image at {imagePath}")
